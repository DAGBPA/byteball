...
ios-prod:
	...
	cd ../dagpizzabuilds/project-IOS-tn && cordova build ios
#	open ../dagpizzabuilds/project-IOS-tn/platforms/ios/DAGPizza.xcodeproj
...
#	cp ./etc/beep.ogg ./cordova/project/plugins/phonegap-plugin-barcodescanner/src/android/LibraryProject/res/raw/beep.ogg
	cd ../dagpizzabuilds/project-ANDROID-tn && cordova run android --device
