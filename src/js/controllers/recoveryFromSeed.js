...
angular.module('copayApp.controllers').controller('recoveryFromSeed',
	function ($rootScope, $scope, $log, $timeout, profileService) {
		...
		var wallet_defined_by_keys = require('dag-pizza-dough/wallet_defined_by_keys.js');
		var objectHash = require('dag-pizza-dough/object_hash.js');
		try{
			var ecdsa = require('secp256k1');
		}
		catch(e){
			var ecdsa = require('dag-pizza-dough/node_modules/secp256k1' + '');
		}
		var Mnemonic = require('bitcore-mnemonic');
		var Bitcore = require('bitcore-lib');
		var db = require('dag-pizza-dough/db.js');
		var network = require('dag-pizza-dough/network');
		var myWitnesses = require('dag-pizza-dough/my_witnesses');
		...
		function cleanAndAddWalletsAndAddresses(assocMaxAddressIndexes) {
			var device = require('dag-pizza-dough/device');
