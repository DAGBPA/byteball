  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      linux: {
		options: {timestamp: true, mode: true},
        files: [
          {expand: true, cwd: './webkitbuilds/', src: ['dagpizza.desktop', '../public/img/icons/icon-white-outline.ico', '../public/img/icons/icon-white-256.png'], dest: '../dagpizzabuilds/DAGPizza/linux32/', flatten: true, filter: 'isFile', options: {timestamp: true, mode: true} },
          {expand: true, cwd: './webkitbuilds/', src: ['dagpizza.desktop', '../public/img/icons/icon-white-outline.ico', '../public/img/icons/icon-white-256.png'], dest: '../dagpizzabuilds/DAGPizza/linux64/', flatten: true, filter: 'isFile', options: {timestamp: true, mode: true} },
        ],
      }
    },
    karma: {
    ...
    nwjs: {
      options: {
          ...
          macPlist: {CFBundleURLTypes: [{CFBundleURLName: 'DAG Pizza action', CFBundleURLSchemes: ['dagpizza']}], /*CFBundleIconFile: 'nw.icns',*/ LSHasLocalizedDisplayName: 0}
      },
    ...
    compress: {
      linux32: {
        options: {
          archive: '../dagpizzabuilds/dagpizza-linux32.zip'
        },
        expand: true,
        cwd: '../dagpizzabuilds/DAGPizza/linux32/',
        src: ['**/*'],
        dest: 'dagpizza-linux32/'
      },
      linux64: {
        options: {
          archive: '../dagpizzabuilds/dagpizza-linux64.zip'
        },
        expand: true,
        cwd: '../dagpizzabuilds/DAGPizza/linux64/',
        src: ['**/*'],
        dest: 'dagpizza-linux64/'
      }
    },
    browserify: {
        dist:{
