module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      osx64: {
        command: '../dagpizzabuilds/build-osx.sh osx64'
      },
      osx32: {
        command: '../dagpizzabuilds/build-osx.sh osx32'
      }
    },
    watch: {
      options: {
    ...
    concat: {
      ...
      js: {
        ...
        dest: 'public/dagpizza.js'
      },
      css: {
        src: ['src/css/*.css'],
        dest: 'public/css/dagpizza.css'
      },
      foundation: {
        src: [
    ...
    uglify: {
      ...
      prod: {
        files: {
          'public/dagpizza.js': ['public/dagpizza.js'],
    ...
    copy: {
      ...
      linux: {
		options: {timestamp: true, mode: true},
        files: [
          {expand: true, cwd: './webkitbuilds/', src: ['dagpizza.desktop', '../public/img/icons/icon-white-outline.ico', '../public/img/icons/icon-white-256.png'], dest: '../dagpizzabuilds/DAGPizza-TN/linux32/', flatten: true, filter: 'isFile', options: {timestamp: true, mode: true} },
          {expand: true, cwd: './webkitbuilds/', src: ['dagpizza.desktop', '../public/img/icons/icon-white-outline.ico', '../public/img/icons/icon-white-256.png'], dest: '../dagpizzabuilds/DAGPizza-TN/linux64/', flatten: true, filter: 'isFile', options: {timestamp: true, mode: true} },
        ],
      }
    },
    karma: {
    ...
    nwjs: {
      options: {
          ...
          macPlist: {CFBundleURLTypes: [{CFBundleURLName: 'DAG Pizza action', CFBundleURLSchemes: ['dagpizza-tn']}], /*CFBundleIconFile: 'nw.icns',*/ LSHasLocalizedDisplayName: 0}
      },
    ...
    compress: {
      linux32: {
        options: {
          archive: '../dagpizzabuilds/dagpizza-tn-linux32.zip'
        },
        expand: true,
        cwd: '../dagpizzabuilds/DAGPizza-TN/linux32/',
        src: ['**/*'],
        dest: 'dagpizza-tn-linux32/'
      },
      linux64: {
        options: {
          archive: '../dagpizzabuilds/dagpizza-tn-linux64.zip'
        },
        expand: true,
        cwd: '../dagpizzabuilds/DAGPizza-TN/linux64/',
        src: ['**/*'],
        dest: 'dagpizza-tn-linux64/'
      }
    },
    browserify: {
        dist:{
    ...
    debian_package: {
        linux64: {
            files: [
                {expand: true, cwd: '../dagpizzabuilds/dagpizza-test/linux64/', src: ['**/*'], dest: '/opt/dagpizza-test/'},
                //{expand: true, cwd: '../dagpizzabuilds/dagpizza-test/linux64', src: ['dagpizza.desktop'], dest: '/usr/share/applications/dagpizza-test.desktop'}
            ],
            options: {
                maintainer: {
                    name: 'DAGBPA',
