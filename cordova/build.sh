...
PROJECT="$BUILDDIR/../../dagpizzabuilds/project-$1"
...
if [ ! -d $PROJECT ]; then
	...
	cordova create ../../dagpizzabuilds/project-$1 org.dagpizza.wallet DAGPizza
	checkOK
...
#  checkOK
	...
	cordova plugin add cordova-plugin-customurlscheme --variable URL_SCHEME=dagpizza
	checkOK
